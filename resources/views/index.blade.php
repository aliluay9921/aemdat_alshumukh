    ...
    <header class="position-absolute w-100">
        <div class="container">
            <div class="top-header d-none d-sm-flex justify-content-between align-items-center">
                <div class="contact">
                    <a href="tel:+9647705333603" class="tel"><i class="fa fa-phone"
                            aria-hidden="true"></i>+9647705333603</a>
                ...
                <nav class="d-flex aic">
                    ...
                    <ul class="nav sociaal d-none d-md-flex">
                        <li><a href="https://www.facebook.com/%D8%B4%D8%B1%D9%83%D8%A9-%D8%A7%D8%B9%D9%85%D8%AF%D8%A9-%D8%A7%D9%84%D8%B4%D9%85%D9%88%D8%AE-%D9%84%D9%84%D9%85%D9%82%D8%A7%D9%88%D9%84%D8%A7%D8%AA-%D8%A7%D9%84%D8%B9%D8%A7%D9%85%D8%A9-%D8%A7%D9%84%D9%85%D8%AD%D8%AF%D9%88%D8%AF%D8%A9-103643841272369/"
                                target="_blank"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li><a href="https://www.instagram.com/aemdatalshumukh/?igshid=dqnyqkjcjkiz"><i
        ...
        <div class="container">
            <div class="cta-content d-xl-flex align-items-center justify-content-around text-center text-xl-left">
                <div class="content" data-aos="fade-right" data-aos-delay="200">
                    <h2>عن الشركة</h2>
                    <p>تأسست الشركة في عام 2016. ومنذ ذلك الحين نفذت الشركة العديد من المشاريع السكنية والتجارية. وضعت
            ...
            <div class="row no-gutters">
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="0" data-aos-duration="600">
                        ...
                        <p>تقدم الشركة أفضل الخدمات للشركات بما يتناسب مع متطلبات مشروعهم في أشكال مختلفة من
                            الصناعية والتجارية والمعمارية</p>
                ...
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="600" data-aos-duration="600">
                        ...
                        <p>توضح الفلسفة الكامنة وراء اعمدة الشموخ طريقتنا في ممارسة أعمالها لإيصال رؤيتنا وآرائنا لجميع
                            عملائنا</p>
        ...
        <div class="wrap-slider">
            ...
            <div id="slider">
                @foreach ($projectcompletelast as $item)
                    <img src="/image/{{ $item->image }}" alt="{{ $item->desc }}" data-title="{{ $item->title }}"
                        data-url="#">
                @endforeach
            </div>
        </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide text-center">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img
                                            src="/assets/images/soso.jpg" alt="Testimonial 1"></div>
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600" data-aos-offset="0">
                                        الحياة مول </h5>
                        ...
                        <div class="swiper-slide text-center">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img
                                            src="/assets/images/momo.jpg" alt="Testimonial 1"></div>
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600" data-aos-offset="0">
                                        مجمع سومو السكني</h5>
            ...
            <div class="row contact-info">
                ...
                <div class="col-md-4">
                    <div class="contact-phone">
                        ...
                        <h3>Phone Number</h3>
                        <p><a href="tel:+9647811119970">+9647811119970</a></p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="contact-email">
                        ...
                        <h3>Email</h3>
                        <p> <a href="mailto:Aemdatalshumukh@gmail.com">Aemdatalshumukh@gmail.com</a></p>
                    </div>
                </div>
            </div>
            <div class="mapouter">
