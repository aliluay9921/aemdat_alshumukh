      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mt-5">
            ...
            <div class="alert alert-success" id="succecc" role="alert">
               تمت الاضافة بنجاح
              </div>
                ...
                <div class="container">
                    <form id="formadd" method="POST"  action="{{ route('add.project') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="title" class="form-control"  aria-describedby="emailHelp" placeholder="عنوان المشروع">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">وصف عن المشروع </label>
                          <input type="text" name="desc" class="form-control" id="exampleInputPassword1" placeholder="وصف">
                        </div>
                        <div class="form-group">
