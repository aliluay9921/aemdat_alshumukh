    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 mt-5 ml-5 ">
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <div class="container">
                        <form id="formadd" method="POST" action="{{ route('add.project') }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="desc" id="desc" class="form-control" id="exampleInputPassword1"
                    ...
                    success: function(response) {
                        if (response.errors) {
                            ...
                            if ($("#exampleFormControlSelect1").val() == 1) {
                                ...
                                var notproject = document.getElementById('notproject')
                                    .innerHTML;
